...
-- config for helm-ls https://github.com/qvalentin/helm-ls.nvim/issues/20
  ...
  },
  {
    ...
    dependencies = {
      ...
      -- NOTE: `opts = {}` is the same as calling `require('mason').setup({})`
      {
        ...
        opts = {
          --registries = {
          --'file:/home/patrick/code/mason-registry',
          --},
        },
      },
    ...
    config = function()
      ...
      local servers = {
        ...
        helm_ls = {},
        -- conditonally include these lsps
        groovyls = (function()
          if string.find(vim.fn.hostname(), '^WIN') then
            return {}
          end
        end)(),
        -- rust_analyzer = {},
